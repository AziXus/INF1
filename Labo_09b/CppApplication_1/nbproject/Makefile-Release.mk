...
${OBJECTDIR}/_ext/5c0/Labo_09_ElSheikh_Daubresse.o: ../Labo_09_ElSheikh_Daubresse.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Labo_09_ElSheikh_Daubresse.o ../Labo_09_ElSheikh_Daubresse.cpp

${OBJECTDIR}/_ext/5c0/annexe.o: ../annexe.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/annexe.o ../annexe.cpp

${OBJECTDIR}/_ext/5c0/format.o: ../format.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/format.o ../format.cpp

${OBJECTDIR}/_ext/5c0/traitementDate.o: ../traitementDate.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/traitementDate.o ../traitementDate.cpp
